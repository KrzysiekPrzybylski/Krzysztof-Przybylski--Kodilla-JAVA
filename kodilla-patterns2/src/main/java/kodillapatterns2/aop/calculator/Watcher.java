package kodillapatterns2.aop.calculator;
...
public class Watcher {
    ...
    @Before("execution(* kodillapatterns2.aop.calculator.Calculator.factorial(..))" +
    ...
    @Around("execution(* kodillapatterns2.aop.calculator.Calculator.factorial(..))")
